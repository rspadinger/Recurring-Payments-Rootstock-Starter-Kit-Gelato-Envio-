...
describe("RecurringPayment contract AmountUpdated event tests", () => {
  ...
  it("RecurringPayment_AmountUpdated is created correctly", async () => {
    ...
    const expectedRecurringPaymentAmountUpdated: RecurringPayment_AmountUpdated = {
    ...
    assert.deepEqual(actualRecurringPaymentAmountUpdated, expectedRecurringPaymentAmountUpdated, "Actual RecurringPaymentAmountUpdated should be the same as the expectedRecurringPaymentAmountUpdated");
  });
});
